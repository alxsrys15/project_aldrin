 ...
 * @method \App\Model\Entity\ProductStock newEntity($data = null, array $options = [])
 ...
 * @method \App\Model\Entity\ProductStock[] patchEntities($entities, array $data, array $options = [])
